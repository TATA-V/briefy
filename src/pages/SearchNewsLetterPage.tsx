...
function SearchNewsLetterPage() {
  ...
  return (
    <>
      <Helmet>
        <meta property="og:description" content={`${query}와 관련된 뉴스레터 보러가기`} />
        <title>{query} : 브리피 뉴스레터 검색</title>
      </Helmet>
      <FadeInLayout>
        <DefaultLayout>
...
export default SearchNewsLetterPage;
